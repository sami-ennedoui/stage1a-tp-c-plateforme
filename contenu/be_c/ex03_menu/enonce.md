...
Comme l'entrée clavier est fixée à l'avance, ton programme doit lire dans cet ordre précis à chaque tour de boucle :

1. lis le choix (un entier) ;
2. si le choix vaut 1, 2 ou 3, lis alors la nouvelle valeur (un flottant) ; si le choix est invalide, affiche le message d'erreur et ne lis **pas** de valeur ;
3. affiche la ligne `Nouvelles valeurs : ...` ;
4. demande s'il faut continuer et lis un entier (1 = oui, 0 = non).

Avec ce protocole, l'entrée fournie est : `1`, `9.9`, `1`, `5`, `1`, `2`, `8.8`, `0`.
