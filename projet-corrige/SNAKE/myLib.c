...
/*====================================================================
/ Nom : PROCEDURE printPomme
/ Sémantique : affiche le symbole d'une pomme dans la console à
/  l'endroit ou est placé le curseur [x,y]
/ Paramètres : AUCUN
/ Pré-condition : curseur placé à la coordonnée désirée
...
/*====================================================================
/ Nom : PROCEDURE printSnakeHead
/ Sémantique : affiche le symbole d'une la tete du snake dans la console à
/  l'endroit ou est placé le curseur
/ Paramètres : AUCUN
/ Pré-condition : curseur placé à la coordonnée désirée
/ Post conditions : AUCUNE
/ ====================================================================*/
...
/*====================================================================
/ Nom : PROCEDURE printSnakeBody
/ Sémantique : affiche le symbole du corps du snake dans la console à
/  l'endroit ou est placé le curseur
/ Paramètres : AUCUN
/ Pré-condition : curseur placé à la coordonnée désirée
/ Post conditions : AUCUNE
...
/*====================================================================
/ Nom : PROCEDURE printStadeElement
/ Sémantique : affiche le symbole d'un élément du stade de jeu dans
/ la console à l'endroit ou est placé le curseur
/ Paramètres : AUCUN
/ Pré-condition : curseur placé à la coordonnée désirée
/ Post conditions : AUCUNE
/ ====================================================================*/
...
/*===================================================================================
/ Nom Sémantique : FONCTION random
/ Sémantique : génère un nombre aléatoire entre 0 et 32767
/ Paramètres :
/ number (OUT) - entier : contient un entier aléatoire
/ Pré-condition : AUCUNE
/ Post conditions : Nombre entre 0 et 32767
/ ====================================================================================*/
...
RLUTIL_STRING_T getANSIColor(const int c) {
	switch (c) {
		...
		case BLUE        : return (char*)ANSI_BLUE;
		case GREEN       : return (char*)ANSI_GREEN;
		case CYAN        : return (char*)ANSI_CYAN;
		case RED         : return (char*)ANSI_RED;
		...
		case LIGHTBLUE   : return (char*)ANSI_LIGHTBLUE;
		case LIGHTGREEN  : return (char*)(char*)ANSI_LIGHTGREEN;
		case LIGHTCYAN   : return (char*)ANSI_LIGHTCYAN;
		case LIGHTRED    : return (char*)ANSI_LIGHTRED;
		case LIGHTMAGENTA: return (char*)ANSI_LIGHTMAGENTA;
		case YELLOW      : return (char*)ANSI_YELLOW;
